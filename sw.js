...
// Only pre-cache the app shell — images and videos cache themselves on first view.
// This prevents a single missing file from silently breaking the entire install.
const ASSETS = [
  '/',
  '/index.html',
  '/admin.html',
